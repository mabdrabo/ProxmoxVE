...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/mabdrabo/ProxmoxVE → Fork (top right)
...
git remote add upstream https://github.com/mabdrabo/ProxmoxVE.git
...
- **GitHub**: [community-scripts/ProxmoxVE](https://github.com/mabdrabo/ProxmoxVE)
- **Issues**: [GitHub Issues](https://github.com/mabdrabo/ProxmoxVE/issues)
- **Discussions**: [GitHub Discussions](https://github.com/mabdrabo/ProxmoxVE/discussions)
