...
# upstream   https://github.com/mabdrabo/ProxmoxVE.git (fetch)
# upstream   https://github.com/mabdrabo/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/mabdrabo/ProxmoxVE"
echo ""
